...
public final class InfoMessages {
  ...
  public static final String BASE_PACKAGE_SET = "Set basePackage for genPackage %s to '%s'.";
  ...
  public static final String MODEL_DIRECTORY_SET = "Set modelDirectory to '%s'.";
  public static final String MODEL_DIRECTORY_WOULD_SET = "Would set modelDirectory to '%s'.";
  public static final String MODEL_DIRECTORY_CHANGED = "Changed modelDirectory from '%s' to '%s'.";
